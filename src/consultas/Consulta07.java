    ...
    public static void main(String[] args) {
        try {
            ...
            String xquery = "for $libros in //libro\n" +
                            "order by  $libros/@id ascending\n" +
                            "return concat('ID: ', $libros/@id, ', Autor: ', $libros/autor, ', publicado el ', $libros/fechaPublicacion)";
            
            result = service.query(xquery);
            
            System.out.println("Id de los libros, autor y su fecha de publicación, ordenados ascendentemente");
