    ...
    public static void main(String[] args) {
        try {
            ...
            String xquery = "for $libros in //libro\n" +
                            "return\n" +
                            "    if ($libros/disponible = \"no\")\n" +
                            "    then\n" +
                            "        update replace $libros/prestado\n" +
                            "        with <prestado>si</prestado>\n" +
                            "    else\n" +
                            "        update replace $libros/prestado\n" +
                            "        with <prestado>no</prestado>";
            
            result = service.query(xquery);
            
            System.out.println("Actualizar nodo usando if-else");
